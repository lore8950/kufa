...
<head>
    ...
    <body class="theme-bg">
        <?php
            ...
            $db_works = mysqli_fetch_assoc(mysqli_query($db_connect, $work_query));
        ?>
        ...
        <header>
            ...
            <div class="extra-info">
                ...
                <div class="social-icon-right mt-20">
                        <a href="<?= $db_user_result["Facebook"]?>" target="_blank"><i class="fab fa-facebook-f"></i></a>
                        <a href="<?= $db_user_result["Twitter"]?>" target="_blank"><i class="fab fa-twitter"></i></a>
                        <a href="<?= $db_user_result["Instagram"]?>" target="_blank"><i class="fab fa-instagram"></i></a>
                        <a href="<?= $db_user_result["Linkedin"]?>" target="_blank"><i class="fab fa-linkedin"></i></a>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="./dashboard/img/work-imges/<?=$db_works['work_image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?= $db_works["work_title"]?></h2>
                                    <p>
                                    <?= $db_works["work_description"]?>
                                    </p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="./dashboard/img/profile-img/<?=$db_user_result['Image']?>" alt="img" width="100px" height="100px" style="object-fit:cover; background:#fff; ">
                                            </div>
                                            <div class="post-avatar-content">
                                                <h5><?= $db_user_result["Name"]?></h5>
                                                <p> <?= substr($db_user_result["Bio"],0,150)?></p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© <span><?= $db_user_result["Name"]?></span> | All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
