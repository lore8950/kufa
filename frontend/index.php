...
$id = $_SESSION['auth_id'];
$user_db_query = "SELECT name, email, password, phone_number, profile_pic, facebook, twitter, instagram, Linkedin FROM admins WHERE id=$id";
$user_db = mysqli_query($db_connect,$user_db_query);
$user_db_query_result = mysqli_fetch_assoc($user_db);
        ...
        <header>
            ...
            <div class="extra-info">
                ...
                <div class="social-icon-right mt-20">
                    <a href="$user_db_query_result[facebook]"><i class="fab fa-facebook-f"></i></a>
                    <a href="$user_db_query_result[twitter]"><i class="fab fa-twitter"></i></a>
                    <a href="$user_db_query_result[linkedin]"><i class="fab fa-linkedin"></i></a>
                    <a href="$user_db_query_result[instagram]"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Apurbo Dev</h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s">I'm Apurbo Dev, professional web developer with long time experience in this field​.</p>
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        <li><a href="$user_db_query_result[facebook]"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="$user_db_query_result[twitter]"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="$user_db_query_result[instagram]"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="$user_db_query_result[inkedin]"><i class="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <img src="img/banner/doraemon.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
					...
					<div class="row">
                    <?php
                    $service_query = "SELECT * FROM services WHERE service_status='active'";
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                    <?php
                    $work_query = "SELECT * FROM works WHERE work_status='active'";
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
                                    ...
                                    <img src="../dashboard/uploads/works<?=$work['work_image']?>"alt="img" width="100" height="300">
                                    </div>
								<div class="speaker-overlay">
									<span><?=$work['work_title']?></span>
									<h4><?=$work['work_heading']?></h4>
                                ...
                                foreach ($testimonials as $testimonial) :?>
                                 <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="width:100px; height:100px; object-fit: padding:3px; border:3px solid #fff; cover;  border-radius:50%;" src="../dashboard/uploads/images.jpg<?= $testimonial["Image"]?>" alt="img">
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="contact-form">    
                             <?php
                              ...
                              <p class="btn btn-outline-success"><?=$_SESSION['sent'];?></p> 
                             <?php
                            }
                               unset($_SESSION['sent']);
                                ?>
                                <form action="../dashboard/message.php" method="POST">
